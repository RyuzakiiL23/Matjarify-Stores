...
export default function Cart() {
  ...
  return (
    <div className="flex flex-col h-full relative">
      <div className="flex justify-center text-[20px] items-center m-10">
        My Cart <FaCartShopping className="ml-2" />
      </div>
      ...
      <div className="flex relative">
        <div className="flex flex-col w-2/3 relative border mx-4">
          ...
          {articles.map((article, index) => (
            <div
              className="bg-background flex border px-4 relative"
              key={index}
            >
          ...
          <div className="flex flex-col">
            ...
            >
              <Button className="gap-2 m-2">
                Finaliser votre achat <FaMoneyCheckDollar />{" "}
              </Button>
            </Link>
          </div>
        </div>
