...
export function UserAdressDialog(props: any) {
      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Make changes to your address here. Click save when youre done.
            </DialogDescription>
          </DialogHeader>
          <div className="flex flex-col gap-4 mt-6">
            ...
            <div className="grid w-full max-w-sm items-center gap-1.5">
              <div className="flex gap-2">
                <MdOutlineEmail />
                <Label htmlFor="BusinessAdress">Your Address</Label>
              </div>
              <Input
          ...
          <DialogFooter>
            <button
              type="submit"
              className="h-11 w-28  bg-primary hover:bg-opacity-90 duration-300 text-white px-2 rounded-lg"
            >
              Save changes
            </button>
          </DialogFooter>
